...
The display hardware is rotated 90° clockwise relative to the natural orientation. The preview tool and firmware both handle this transformation automatically.
...
The firmware uses conditional debug logging to minimize memory pressure on the resource-constrained VESC hardware.
